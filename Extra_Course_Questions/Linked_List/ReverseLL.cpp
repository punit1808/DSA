...
Node* reverseLLusingloop(Node* &head,Node* &tail){
    if(head==NULL){
        cout<<"Linked List is Empty"<<endl;
    }
    if(head->next==NULL){
...
Node* reverseLLusingrecursion(Node* prevNode,Node* curr){
    ...
    curr->next=prevNode;
    prevNode=curr;  
    return reverseLLusingrecursion(curr,temp);
}
...
int main(){
    ...
    print(head);
    cout<<endl;
    head=reverseLLusingloop(head,tail);
    print(head);
    cout<<endl;
    Node* prevNode=NULL;
    Node* curr=head;
    head=reverseLLusingrecursion(prevNode,curr);
    print(head);
}
